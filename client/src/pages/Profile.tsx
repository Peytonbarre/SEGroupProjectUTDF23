          ...
          <Container fluid className="vh-100 d-flex justify-content-center align-items-center">
            <Col md={3}>
              <Card className="text-center">
                ...
                <Image
                  src={newProfilePicture ? URL.createObjectURL(newProfilePicture) : userProfile.profilePicture}
                  alt="Profile Image"
                  style={{ width: '200px', height: '200px', margin: '0 auto' }}
                  roundedCircle
                />
                <input className="mb-4" type="file" accept=".jpg,.jpeg,.png" onChange={handleProfilePictureChange} style={{ margin: '0 auto' }} />
